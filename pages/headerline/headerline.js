...
Page({
  ...
  onLoad: function (option) {
    ...
    // //二维码
    // var url = util.GetXCXInfoQRCode('id=' + option.id,'pages/headerline/headerline', app.globalData.loginInfo.siteId,function(url){
    //   wx.getImageInfo({
    //     src: url,
  ...
  shareFn: function (e) {
    ...
    var ewx = '';
    //二维码
    var url = util.GetXCXInfoQRCode('id=' + that.data.detailId, 'pages/headerline/headerline', app.globalData.loginInfo.siteId, function (url) {
